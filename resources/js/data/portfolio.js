...
export const PROJECTS = [
  {
    ...
    video:  null, // replace with '/videos/aqualume.mp4'
    year:   '2024',
    color:  '#2dd4bf',
...
export const SKILLS = [
  { category: 'Web Development',    items: ['HTML/CSS', 'JavaScript', 'React', 'Laravel', 'PHP', 'SAP Fiori'] },
  { category: 'Mobile & Game Dev',  items: ['Flutter', 'Android', 'Unity', 'Unreal Engine', 'C#', 'Dart'] },
  { category: 'IoT & Systems',      items: ['ESP32', 'IoT Design', 'SAP HANA', 'Circuit Design', 'C++'] },
  { category: 'Tools & Workflow',   items: ['Git', 'GitHub', 'Figma', 'VS Code', 'Android Studio'] },
]
